...
const postsDirectory = path__WEBPACK_IMPORTED_MODULE_1___default().join(process.cwd(), "writings");
async function getSortedPostsData() {
    ...
    const allPostsData = fileNames.map((fileName)=>{
        ...
        const processedContent = (0,remark__WEBPACK_IMPORTED_MODULE_3__.remark)().use(remark_html__WEBPACK_IMPORTED_MODULE_4__["default"]).processSync(matterResult.content).toString();
